    ...
    module api {
        ...
        module db {
            ...
            interface Callback extends
                ...
                , methods.put.Callback, methods.remove.Callback, methods.query.Callback {
            }
            ...
            interface Promisable extends
                ...
                , methods.put.Promisable, methods.remove.Promisable, methods.query.Promisable {
            }

            module replicate {

                export interface Callback extends methods.replicate.from.Callback {
                }
                export interface Promisable extends methods.replicate.from.Promisable {
                }
            }
